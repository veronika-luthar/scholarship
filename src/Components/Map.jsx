...
//Image Map Generated by http://www.image-map.net/ 
    ...
    const Map = () => {
        ...
        for(let i = 0; i < results.length; i++){
            ...
            radioButton.value = results[i];
            radioButton.classList.add("radio-button");
            document.body.appendChild(radioButton);
            document.body.appendChild(label);

            radioButton.onclick = function test(){
                console.log("eslec");
            }
        }
...
console.log('bla');
        ...
        return (
             ...
             <img src= {zoneMap} className='map' usemap="#image-map" style={{ height: '90%', width: 'auto' }}></img>
                <map name={mapName} className="map-class">
                    ...
                    <area target="" onClick={checkSelected} alt="Mosgiel" title="Mosgiel" href="ML" coords="144,172,35,206,9,225,19,253,10,282,25,310,62,307,79,293,75,271,70,258,88,246,106,225,144,201,151,182" shape="poly"></area>
                </map>
             </div>
